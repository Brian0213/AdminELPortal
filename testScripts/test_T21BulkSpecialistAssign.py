...
class Test_Bulk_Specialist_Assign(BaseTest):
    ...
    def test_login(self, setup):
        ...
        self.elportal.find_element(By.XPATH, "//button[@class='btn-sm bg-white border border-primary-400 hover:border-gray-700 text-primary-800']").click()
        self.prac.learnerAssignSite()
        self.elportal.find_element(By.XPATH, "//body/div[4]/div[2]/div/mbody/div/div[1]/div").click()
        self.prac.enterLearnerSite()
        # self.elportal.find_element(By.XPATH, "//div[@role='listbox']//div[@data-value='117']").click()
        self.prac.enterExpectedHours(self.hour)
        # self.elportal.find_element(By.XPATH, "//input[@id='hours']").send_keys("10")
